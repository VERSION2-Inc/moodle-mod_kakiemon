...
$this->sans_fonts = array(
        'ipaexg',
        'dejavusanscondensed','dejavusans','freesans','liberationsans','sans','sans-serif','cursive','fantasy',
...
$this->serif_fonts = array(
        'ipaexm',
        'dejavuserifcondensed','dejavuserif','freeserif','liberationserif','serif',
